...
public class LifeGameFrame extends javax.swing.JFrame 
    ...
    private void initComponents() {
        ...
        jButton1.setText("100 White Spaces");
        ...
        jButton2.setText("Random row white");
        ...
        jButton3.setText("Top half white");
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        // TODO add your handling code here:
        // Check if any black squares are touching 2 or more white squares
        // If true, make the black square white
        int count = 0;
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        // TODO add your handling code here:
        // Shifts columns left 1 space
        int[][] temp = new int[gridCount][gridCount];
        for (int row = 0; row < 100; row++) {
            for (int col = 0; col < 100; col++) {
                if (grid[col][row] == 1) {
                    if (col % gridCount == 0) {
                        temp[gridCount-1][row] = 1;
                    }
                    else {
                        temp[(col-1) % gridCount][row] = 1;
                    }
                }
            }
        }
